...
```bash
bitasmbl pull --repoUrl https://github.com/he1snber8/Bitasmbl_maybach-with-heatseats_765_375 --appId 375 --repoId 203
```

## 3) Enter into the main directory and start coding!

```bash
cd Bitasmbl_maybach-with-heatseats_765_375
```
